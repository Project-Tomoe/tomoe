...
describe("RadixTree", () => {
  ...
  describe("Insertion", () => {
    ...
    it("should warn overwriting existing route", () => {
      ...
      expect(conSpy).toHaveBeenCalledWith(expect.stringContaining("Route already registered"))
  ...
  describe("Route with Params (Dynamic Parameters", () => {
    ...
    it("should warn for conflicting parameter names", () => {
      ...
      expect(conSpy).toHaveBeenCalledWith(expect.stringContaining("Parameter name conflict"))
