...
describe("Context", () => {
  ...
  beforeEach(() => {
    ...
    request = new Request("https://dummyjson.com/posts/24?title=moonlit&writer=tomoe", {
      method: "GET",
      headers: {
  ...
  describe("constructor", () => {
    ...
    it("should accept environment", () => {
      const ctx = new Context(request, {}, { hero: { heroName: "mio", statsId: 1 } })
  ...
  describe("json()", () => {
    ...
    it("should merge headers", () => {
      const response = context.json({ data: "test" }, { headers: { "X-Custom": "value" } })
